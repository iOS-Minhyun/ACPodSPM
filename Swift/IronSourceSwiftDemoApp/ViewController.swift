...
class ViewController: UIViewController, ISRewardedVideoDelegate, ISOfferwallDelegate, ISInterstitialDelegate, ISBannerDelegate,ISImpressionDataDelegate {
    ...
    @IBOutlet weak var loadRVButton: UIButton!
    var bannerView: ISBannerView! = nil

    //MARK: IBOutlets Actions
    
    @IBAction func loadRVButtonAction(_ sendeR: Any) {
...
//        ISMomentoCustomAdapter().setRewardVideoSkipEnabled(true)
//        MomentSDK.shared.setRewardVideoSkipEnabled(true)
    }
...
//extension ViewController: ISMomentoCustomAdapterDelegate {
//    func onVideoClicked(type: String) {
//        print("CMH :: onVideoClicked - \(type)")
//    }
//
//    func onVideoLoaded(dspName: String) {
//        print("CMH :: onVideoLoaded - \(dspName)")
//    }
//
//    func onVideoStoped() {
//        print("CMH :: onVideoStoped")
//    }
//
//    func onVideoComplete() {
//        print("CMH :: onVideoComplete")
//    }
//
//    func onVideoRewarded(state: Bool) {
//        print("CMH :: onVideoRewarded - \(state)")
//    }
//
//    func onVideoTimedout() {
//        print("CMH :: onVideoTimedout")
//    }
//
//    func onVideoShown() {
//        print("CMH :: onVideoShown")
//    }
//
//    func onVideoClosed() {
//        print("CMH :: onVideoClosed")
//    }
//
//    func onVideoRemoved() {
//        print("CMH :: onVideoRemoved")
//    }
//
//    func onVideoClicked(type: MomentoIOS.MomentSDK.videoClickType) {
//        print("CMH :: onVideoClicked - \(type)")
//    }
//
//    func onVideoLoadFailed(description: String) {
//        print("CMH :: onVideoLoadFailed - \(description)")
//    }
//
//    func onVideoShowFailed(description: String) {
//        print("CMH :: onVideoShowFailed - \(description)")
//    }
//}
